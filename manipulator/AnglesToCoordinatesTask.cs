...
namespace Manipulation
{
    public static class AnglesToCoordinatesTask
    {
        ...
        /// <summary>
        /// ¬ычисление точки конца радиус-вектора 
        ...
        /// <summary>
        /// ѕо значению углов суставов возвращает массив координат суставов
        /// в пор€дке new []{elbow, wrist, palmEnd}
        /// </summary>
    ...
    public class AnglesToCoordinatesTask_Tests
    {
        ...
        // ƒоработайте эти тесты!
        // — помощью строчки TestCase можно добавл€ть новые тестовые данные.
        // јргументы TestCase преврат€тс€ в аргументы метода.
