...
namespace Clones
{
	...
	public class CloneVersionSystem_should
	{
		...
		[Test]
		public void MassiveLearnRollbackRelearn()
		{
			var res = Execute("learn 1 6",
				"learn 1 5",
				"learn 1 4",
				"learn 1 3",
				"learn 1 2",
				...
				"relearn 1",
				"check 1");
			Assert.AreEqual(new[] { "2", "5", "6", "3", "2" }, res);
		}

		[Test]
		public void MassiveLearnRollbackRelearnClone()
		{
			var res = Execute("learn 1 10",
				"learn 1 9",
				"learn 1 8",
				"learn 1 7",
				"learn 1 6",
